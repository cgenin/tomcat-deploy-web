          ...
          <fieldset>
            <div className="form-group" style={formGroupStyle}>
              ...
              <input type="text" className="form-control" id="host" placeholder="Host of nexus"
                     defaultValue={this.props.nexus.host} onChange={this.onChange} ref="host"
              />
            </div>
            <div className="form-group" style={formGroupStyle}>
              ...
              <input type="number" className="form-control" id="port" placeholder="Default to 80"
                     defaultValue={this.props.nexus.port} onChange={this.onChange} ref="port"
              />
            </div>
            <div className="form-group" style={formGroupStyle}>
              <label className="control-label" htmlFor="context">Context</label>
              <input type="text" className="form-control" id="context" placeholder="/"
                     defaultValue={this.props.nexus.context} onChange={this.onChange} ref="context"
              />
            </div>
          </fieldset>
        </form>
